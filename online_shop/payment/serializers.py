...
from location.serializers import BillingAddressSerializer, ShippingAddressSerializer
...
class PaymentSerializer(serializers.ModelSerializer):
    ...
    """
    customer = serializers.CharField(source='order.customer.full_name', read_only=True)

    class Meta:
        model = Payment
        fields = ('id', 'buyer', 'status', 'payment_option', 'order', 'created', 'updated')
