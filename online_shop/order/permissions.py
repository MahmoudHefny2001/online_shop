...
class IsOrderPending(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        if view.action in ('Arrived',):
            return True
        return obj.status == 'Not Arrived'


class IsOrderItemByCustomererOrAdmin(BasePermission):
    """
    ...
    def has_permission(self, request, view):
        ...
        return order.customer == request.user or request.user.is_staff

    def has_object_permission(self, request, view, obj):
        return obj.order.customer == request.user or request.user.is_staff


class IsOrderByCustomerOrAdmin(BasePermission):
    """
...
class IsOrderItemPending(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return order.status == 'Not Arrived'

    def has_object_permission(self, request, view, obj):
        if view.action in ('retrieve',):
            return True
        return obj.order.status == 'Not Arrived'